...
def extract_blue_channel(image_path, output_name):
    ...
    # Memisahkan channel warna biru (Blue)
    blue = image[:, :, 1]
    ...
    output_path = f"{output_name}_blue.jpeg"
    img.imwrite(output_path, image_blue)
    print(f"Gambar channel biru untuk {output_name} berhasil disimpan sebagai {output_path}")
